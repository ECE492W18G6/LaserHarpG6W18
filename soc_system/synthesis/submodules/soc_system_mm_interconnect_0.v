...
module soc_system_mm_interconnect_0 (
	...
	wire  [117:0] red_leds_s1_agent_rp_data;                                                           // red_leds_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [117:0] timer_0_s1_agent_rp_data;                                                            // timer_0_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [117:0] cmd_mux_003_src_data;                                                                // cmd_mux_003:src_data -> sysid_qsys_0_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                                               // sysid_qsys_0_control_slave_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire   [10:0] cmd_mux_003_src_channel;                                                             // cmd_mux_003:src_channel -> sysid_qsys_0_control_slave_burst_adapter:sink0_channel
	...
	wire          cmd_mux_004_src_valid;                                                               // cmd_mux_004:src_valid -> red_leds_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_004_src_data;                                                                // cmd_mux_004:src_data -> red_leds_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                               // red_leds_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire   [10:0] cmd_mux_004_src_channel;                                                             // cmd_mux_004:src_channel -> red_leds_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                       // cmd_mux_004:src_startofpacket -> red_leds_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                         // cmd_mux_004:src_endofpacket -> red_leds_s1_burst_adapter:sink0_endofpacket
	...
	wire   [10:0] cmd_mux_010_src_channel;                                                             // cmd_mux_010:src_channel -> timer_0_s1_burst_adapter:sink0_channel
	...
	wire          red_leds_s1_agent_rdata_fifo_out_valid;                                              // red_leds_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] red_leds_s1_agent_rdata_fifo_out_data;                                               // red_leds_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          red_leds_s1_agent_rdata_fifo_out_ready;                                              // avalon_st_adapter_004:in_0_ready -> red_leds_s1_agent_rdata_fifo:out_ready
