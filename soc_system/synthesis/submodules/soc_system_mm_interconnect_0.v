...
module soc_system_mm_interconnect_0 (
	...
	wire   [90:0] photodiode_0_avalon_slave_agent_rp_data;                                             // photodiode_0_avalon_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [117:0] buttons_s1_agent_rp_data;                                                            // buttons_s1_agent:rp_data -> router_010:sink_data
	...
	wire    [9:0] cmd_mux_src_channel;                                                                 // cmd_mux:src_channel -> audio_0_avalon_audio_slave_burst_adapter:sink0_channel
	...
	wire    [9:0] cmd_mux_001_src_channel;                                                             // cmd_mux_001:src_channel -> audio_and_video_config_0_avalon_av_config_slave_burst_adapter:sink0_channel
	...
	wire    [9:0] character_lcd_0_avalon_lcd_slave_burst_adapter_source0_channel;                      // character_lcd_0_avalon_lcd_slave_burst_adapter:source0_channel -> character_lcd_0_avalon_lcd_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_003_src_channel;                                                             // cmd_mux_003:src_channel -> EnvelopeController_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire    [9:0] envelopecontroller_0_avalon_slave_burst_adapter_source0_channel;                     // EnvelopeController_0_avalon_slave_burst_adapter:source0_channel -> EnvelopeController_0_avalon_slave_agent:cp_channel
	...
	wire    [9:0] photodiode_0_avalon_slave_burst_adapter_source0_channel;                             // photodiode_0_avalon_slave_burst_adapter:source0_channel -> photodiode_0_avalon_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_005_src_channel;                                                             // cmd_mux_005:src_channel -> Synthesizer_0_avalon_slave_0_burst_adapter:sink0_channel
	...
	wire    [9:0] synthesizer_0_avalon_slave_0_burst_adapter_source0_channel;                          // Synthesizer_0_avalon_slave_0_burst_adapter:source0_channel -> Synthesizer_0_avalon_slave_0_agent:cp_channel
	...
	wire    [9:0] cmd_mux_006_src_channel;                                                             // cmd_mux_006:src_channel -> sysid_qsys_0_control_slave_burst_adapter:sink0_channel
	...
	wire    [9:0] cmd_mux_007_src_channel;                                                             // cmd_mux_007:src_channel -> switches_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_008_src_valid;                                                               // cmd_mux_008:src_valid -> buttons_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_008_src_data;                                                                // cmd_mux_008:src_data -> buttons_s1_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                                               // buttons_s1_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire    [9:0] cmd_mux_008_src_channel;                                                             // cmd_mux_008:src_channel -> buttons_s1_burst_adapter:sink0_channel
	wire          cmd_mux_008_src_startofpacket;                                                       // cmd_mux_008:src_startofpacket -> buttons_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                         // cmd_mux_008:src_endofpacket -> buttons_s1_burst_adapter:sink0_endofpacket
	...
	wire    [9:0] cmd_mux_009_src_channel;                                                             // cmd_mux_009:src_channel -> red_leds_s1_burst_adapter:sink0_channel
	...
	wire    [9:0] router_004_src_channel;                                                              // router_004:src_channel -> character_lcd_0_avalon_lcd_slave_rsp_width_adapter:in_channel
	...
	wire    [9:0] character_lcd_0_avalon_lcd_slave_rsp_width_adapter_src_channel;                      // character_lcd_0_avalon_lcd_slave_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	...
	wire   [90:0] router_006_src_data;                                                                 // router_006:src_data -> photodiode_0_avalon_slave_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                                // photodiode_0_avalon_slave_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [9:0] router_006_src_channel;                                                              // router_006:src_channel -> photodiode_0_avalon_slave_rsp_width_adapter:in_channel
	...
	wire  [117:0] photodiode_0_avalon_slave_rsp_width_adapter_src_data;                                // photodiode_0_avalon_slave_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	...
	wire    [9:0] photodiode_0_avalon_slave_rsp_width_adapter_src_channel;                             // photodiode_0_avalon_slave_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire    [9:0] cmd_mux_002_src_channel;                                                             // cmd_mux_002:src_channel -> character_lcd_0_avalon_lcd_slave_cmd_width_adapter:in_channel
	...
	wire    [9:0] character_lcd_0_avalon_lcd_slave_cmd_width_adapter_src_channel;                      // character_lcd_0_avalon_lcd_slave_cmd_width_adapter:out_channel -> character_lcd_0_avalon_lcd_slave_burst_adapter:sink0_channel
	...
	wire  [117:0] cmd_mux_004_src_data;                                                                // cmd_mux_004:src_data -> photodiode_0_avalon_slave_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                               // photodiode_0_avalon_slave_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [9:0] cmd_mux_004_src_channel;                                                             // cmd_mux_004:src_channel -> photodiode_0_avalon_slave_cmd_width_adapter:in_channel
	...
	wire    [9:0] photodiode_0_avalon_slave_cmd_width_adapter_src_channel;                             // photodiode_0_avalon_slave_cmd_width_adapter:out_channel -> photodiode_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire          buttons_s1_agent_rdata_fifo_out_valid;                                               // buttons_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] buttons_s1_agent_rdata_fifo_out_data;                                                // buttons_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	wire          buttons_s1_agent_rdata_fifo_out_ready;                                               // avalon_st_adapter_008:in_0_ready -> buttons_s1_agent_rdata_fifo:out_ready
