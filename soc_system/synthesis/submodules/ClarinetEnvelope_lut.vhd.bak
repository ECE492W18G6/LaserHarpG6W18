...
-- index inside this clarinet envelope LUT. In order for the output to not be 0, you must enable           --
-- en to '1'.                                                                                       	--
----------------------------------------------------------------------------------------------------------
...
entity ClarinetEnvelope_lut is 
...
end ClarinetEnvelope_lut;

architecture rtl of ClarinetEnvelope_lut is
